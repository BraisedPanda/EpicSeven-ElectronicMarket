...
<html>
  ...
  <div class="top_1">
    ...
    <div class="detail">
  	...
  	<div class="tt"></div>
  	<div class="page">
  		<a href="<c:url value='/goodsAction_findAllEquipment?currentPage=1'/>" target="_top">首页</a>
  		&nbsp;&nbsp;&nbsp;
  		<c:if test="${pageBean.currentPage-1 >0 }">
  		<a href="<c:url value='/goodsAction_findAllEquipment?currentPage=${pageBean.currentPage-1 }'/>" target="_top">上一页</a>
  		</c:if>
  			&nbsp;&nbsp;&nbsp;
  		第 ${pageBean.currentPage } 页/共 ${pageBean.totalPage } 页
  			&nbsp;&nbsp;&nbsp;
  		<c:if test="${pageBean.currentPage+1 <= pageBean.totalPage }">
  		<a href="<c:url value='/goodsAction_findAllEquipment?currentPage=${pageBean.currentPage+1 }'/>" target="_top">下一页</a>
  		</c:if>
  		</div>
     <div class="foot">
