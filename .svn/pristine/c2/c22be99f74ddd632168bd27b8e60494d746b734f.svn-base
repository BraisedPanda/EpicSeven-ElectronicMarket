...
<html>
  <head>
	...
	<style>
		...
		.body_1_1{
		width:100%;
		border-bottom:2px solid #5dbe8a;
		height:40px;
		} 
		.detail{
  ...
  <div class="top_1">
    ...
    <iframe src="<c:url value='/menu/top_2.jsp'/>" class="top_2"></iframe>
 	...
 	<div class="body_1_1">
    <iframe src="<c:url value='/order/body_1_2.jsp'/>" class="center_1"></iframe>
    </div>
    <div class="detail">
  		...
  		<div class="cart1">
  			 <div class="image"><img src="<c:url value='/${orderItem.goods.image }'/>"></div> 
				...
				<div class="total">
					...
					<a class="buy" id="buy" href="<c:url value='/cartAction_payment?price=${orderItem.subtotal }'/>">付款</a>
				</div>
				</div>
